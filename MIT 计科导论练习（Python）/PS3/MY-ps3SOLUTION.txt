...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        """
        dirt=self.get_dirt_amount(int(pos.get_x()),int(pos.get_y()))
        if dirt<=capacity:
            self.dirt_amount[int(pos.get_x()),int(pos.get_y())]=0
        else:
            self.dirt_amount[int(pos.get_x()),int(pos.get_y())]-=capacity
    ...
    def get_num_cleaned_tiles(self):
        ...
        """
        clean_tile=0
        for tile in self.dirt_amount.values():
            if tile==0:
                clean_tile+=1
        return clean_tile
    ...
    def get_dirt_amount(self, m, n):
        ...
        Returns: an integer
        """
        return self.dirt_amount[int(m),int(n)]
...
##a=RectangularRoom(3,3,5)
####print(a.dirt_amount[2,1])
##print(a.get_dirt_amount(2,1))
###return  self.width*self.height
##b=Position(1.5,2.6)
##print(a.is_position_in_room(b))
##print(a.is_tile_cleaned(2.2,1.1))
##a.clean_tile_at_position(b,8)
##print(a.get_dirt_amount(1,2))
...
class EmptyRoom(RectangularRoom):
    ...
    def get_num_tiles(self):
        ...
        Returns: an integer; the total number of tiles in the room
        """
        return  RectangularRoom.get_num_tiles(self)
    ...
    def is_position_valid(self, pos):
        ...
        Returns: True if pos is in the room, False otherwise.
        """
        return RectangularRoom.is_position_valid(self,pos)
    ...
    def get_random_position(self):
        ...
        return RectangularRoom.get_random_position(self)
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        """
        return  RectangularRoom.is_position_valid(self,pos) and not self.is_position_furnished(pos)
    ...
    def get_random_position(self):
        ...
        """
        pos=RectangularRoom.get_random_position(self)
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        newpos=current_position.get_new_position(current_direction,self.speed)
        if self.room.is_position_valid(newpos):
            self.pos=newpos #move the robot to new position
            self.room.clean_tile_at_position(newpos,self.capacity) #clean the tile with capacity
        else:
            self.direction=random.random()*360 #randomly rotate the robot
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for trial in range(num_trials):
        ...
        anim = ps3_visualize.RobotVisualization(num_robots, width, height, False, delay=0.2)
        time_step=0
...
run_simulation(2, 1.0, 1, 10, 10, 3, 1.0, 1, StandardRobot)
...
#       of a 20x20 room?
#avg time steps of StandardRobot: 2063.02
##avg time steps of FaultyRobot: 2466.16
...
'''avg time steps of  StandardRobot&10x30: 1569.94
avg time steps of FaultyRobot&10x30: 2017.5
avg time steps of  StandardRobot&10x30: 1586.36
avg time steps of FaultyRobot&10x30: 1921.9
avg time steps of  StandardRobot&10x30: 1580.64
avg time steps of FaultyRobot&10x30: 1937.12
avg time steps of  StandardRobot&10x30: 1686.08
avg time steps of FaultyRobot&10x30: 2436.34'''

####print ('avg time steps of  StandardRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 10, 30, 3, 0.8, 50, StandardRobot)))
####print ('avg time steps of FaultyRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 10, 30, 3, 0.8, 50, FaultyRobot)))
####print ('avg time steps of  StandardRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 20, 15, 3, 0.8, 50, StandardRobot)))
####print ('avg time steps of FaultyRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 20, 15, 3, 0.8, 50, FaultyRobot)))
####print ('avg time steps of  StandardRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 25, 12, 3, 0.8, 50, StandardRobot)))
####print ('avg time steps of FaultyRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 25, 12, 3, 0.8, 50, FaultyRobot)))
####print ('avg time steps of  StandardRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 50, 6, 3, 0.8, 50, StandardRobot)))
####print ('avg time steps of FaultyRobot&10x30: ' + str(run_simulation(1, 1.0, 1, 50, 6, 3, 0.8, 50, FaultyRobot)))
...
##anim = ps3_visualize.RobotVisualization(1, 20, 20, False, delay=0.2)
##anim.update(room, robots)
##anim.done()
